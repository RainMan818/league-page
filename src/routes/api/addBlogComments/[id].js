...
export async function post(req) {
  ...
  const POST_COMMENTS = `https://api.contentful.com/spaces/${
    import.meta.env.VITE_CONTENTFUL_SPACE
  }/environments/master/entries/${makeid(postID, 10)}`;
  ...
  const PUBLISH_COMMENT = `https://api.contentful.com/spaces/${
    import.meta.env.VITE_CONTENTFUL_SPACE
  }/environments/master/entries/${commentID}/published`;
