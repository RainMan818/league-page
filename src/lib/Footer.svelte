<script>
  ...
  const resize = (w) => {
    ...
    const bottom = el?.getBoundingClientRect()
      ...
      : 0;
    const topNeedUpdate = elNeedUpdate?.getBoundingClientRect()
      ? elNeedUpdate?.getBoundingClientRect().top
      : 0;
    const bottomNeedUpdate = elNeedUpdate?.getBoundingClientRect()
      ? elNeedUpdate?.getBoundingClientRect().bottom
      : 0;
...
<div
  class="footerSpacer"
  style="height: {outOfDate ? footerHeightNeedUpdate : footerHeight}px;"
/>
...
<footer class={outOfDate ? "" : "invisible"} bind:this={elNeedUpdate}>
  <p class="updateNotice">
    There is an update available for your League Page. <a
      href="https://github.com/nmelhado/league-page/blob/master/TRAINING_WHEELS.md#iii-updates"
  ...
  >
  <span class="creator"
    >Improved upon by <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"
      >Rainman001</a
    ><br /></span
  >
</footer>
...
<footer class={!outOfDate ? "" : "invisible"} bind:this={el}>
  ...
  >
  <span class="creator"
    >Improved upon by <a href="https://tinyurl.com/mvjd7p2b">Rainman001</a><br
    /></span
  >
</footer>
